...
export const CREATE_USER_ACTION = createAction(
  "create user action",
...
export const DELETE_USER = createAction("delete  user", (payload: string) => ({
  payload,
}));

export const UPDATE_USER_ACTION = createAction(
  "update  user",
  (payload: { user: UserModel; message?: string }) => ({ payload })
);
...
export const SUCCESS_MESSAGE_ACTION = createAction(
